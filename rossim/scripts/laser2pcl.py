...
class Laser2pcl():
	...
	def __init__(self):
    		...
    		rospy.init_node("laserscan_to_pointcloud",anonymous=False)
    
   		# lp = lg.LaserProjection()
   		rospy.Subscriber("/scan", LaserScan, scan_cb, queue_size=10)
   		self.pcl_pub = rospy.Publisher("/pcl", PointCloud2, queue_size=10)
   		self.pcl_pub.publish(0)
