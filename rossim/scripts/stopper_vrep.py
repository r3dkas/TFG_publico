...
class Stopper():
    ...
    def __init__(self):
        ...
        self.leftmotor = rospy.Publisher("/vrep_ros_interface/leftMotorSpeed",Float32,queue_size=10)
        self.rightmotor = rospy.Publisher("/vrep_ros_interface/rightMotorSpeed",Float32,queue_size=10)
